...
description: "AcceptQuote contract message reference for legacy TrueCurrent taker docs: single and multi-quote aggregation, encoding, partial fills, and onchain validation."
...
The full list of per-quote failures is available in the emitted settlement event under `quote_results`, keyed by maker address. Inspect it in a failed quote to diagnose exactly which quote was rejected and why.
