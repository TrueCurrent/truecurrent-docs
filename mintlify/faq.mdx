...
<AccordionGroup>
  <Accordion title="What is TrueCurrent?">
    ...
    Instead of trading against an automated market maker or a passive order book, you receive live, competitive quotes from professional liquidity providers and execute at the locked-in price with no slippage.
  </Accordion>
