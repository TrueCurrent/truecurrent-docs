...
<AccordionGroup>
  ...
  <Accordion title="Why did my quote expire before I could accept?">
    Live market maker quotes are valid for about 2 seconds. That window is short by design — it protects makers from being locked into stale prices in fast-moving markets, which in turn keeps spreads tight.
