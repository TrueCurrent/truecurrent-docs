---
title: "TP/SL liquidity (legacy)"
description: "Legacy guide: how makers quote against pre-signed TP/SL taker intents on TrueCurrent using the same EIP-712 v2 quote flow as live RFQ requests."
