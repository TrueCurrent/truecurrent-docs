...
description: "Sequence diagrams and market reference for TrueCurrent's RFQ system, including the standard AcceptQuote flow and the TP/SL AcceptSignedIntent path."
...
sequenceDiagram
    ...
    Chain->>Chain: Settle both positions atomically
