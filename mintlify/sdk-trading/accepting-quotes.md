...
- [Best practices](/sdk-trading/taker-best-practices) – slippage strategy, expiry races, idempotency
- [TakerStream](/sdk-trading/taker-stream) – collecting quotes to feed into `AcceptQuote`
- [Signed taker intents](/sdk-trading/signed-intents) - the conditional/TP-SL path (pre-signed trigger-gated intents executed by the TP/SL executor)
- [Authorization setup](/sdk-trading/authz) – the grants you need before any of this works
