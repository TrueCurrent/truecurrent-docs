---
title: "Taker best practices"
description: "Production guidance for programmatic RFQ takers on TrueCurrent: worst_price strategy, quote expiry, balances, idempotency, reconnection, and error handling."
updatedAt: "2026-05-06"
---

This page is the collected wisdom for running a programmatic taker in production. First, complete the [Quickstart](/sdk-trading/taker-quickstart), and then implement the best practices here.
...
**Check your subaccount balance** before submitting requests. If it is below your requested margin, every `AcceptQuote` will fail with `insufficient balance`.
...
When you submit a multi-quote `AcceptQuote`, the contract processes quotes in order and **skips** quotes that fail validation rather than aborting the whole transaction (see [Accepting quotes](/sdk-trading/accepting-quotes)).
