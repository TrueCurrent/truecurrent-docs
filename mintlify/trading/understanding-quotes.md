...
When you request a trade on TrueCurrent, liquidity providers respond with quotes. Understanding what a quote contains – and what it commits to – helps you trade more effectively.
...
If no liquidity provider responds within the 2-second window, TrueCurrent automatically routes your order to Injective's onchain order book. In this case:
