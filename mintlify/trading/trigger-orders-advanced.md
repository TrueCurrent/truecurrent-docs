...
If no liquidity provider is quoting at the moment the trigger fires — because they're offline, have insufficient balance, or have withdrawn liquidity — there are no quotes to fill against. The relayer cannot construct a valid settlement transaction.
...
3. At execution time, the trigger condition (mark ≤ \$4.80) is satisfied. But no liquidity provider is willing to quote at \$4.75 or better when the mark price is at \$4.60 — the asset is now worth less than your floor.
