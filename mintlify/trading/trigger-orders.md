...
See [Liquidation](liquidation.md) to understand the difference between a stop loss (which you control) and a liquidation (which happens automatically when margin runs out).
