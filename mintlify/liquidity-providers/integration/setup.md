...
description: "One-time onboarding steps for liquidity providers: generate an Injective wallet, get whitelisted, grant authz permissions to the RFQ contract, and fund your exchange subaccount."
