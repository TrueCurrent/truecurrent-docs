...
Set your margin, leverage, and price tolerance (the worst price you're willing to accept). When you click **Trade**, TrueCurrent automatically collects prices from institutional liquidity providers, picks the best one, and executes – all in under a second.
...
**Your price floor is always respected.** You set a price tolerance before trading. The trade will never execute at a worse price than your limit – if no provider can beat it, the trade simply doesn't go through.
