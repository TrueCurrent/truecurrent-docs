---
title: "RFQ explained"
description: "Technical deep dive into TrueCurrent's RFQ protocol architecture covering liquidity provider competition, quote expiry mechanics, hybrid order book fallback, and atomic settlement on Injective blockchain."
updatedAt: "2026-05-05"
---

Request for Quote (RFQ) is a trading model where a buyer or seller solicits price quotes from one or more liquidity providers before committing to a trade. Unlike automated pricing models, RFQ involves human or algorithmic liquidity providers actively pricing each individual trade.
...
- **Better prices for larger trades.** Liquidity providers can offer tighter spreads on larger sizes than any AMM pool.
...
- **Better for large sizes.** A large market order on an order book walks up the book, paying progressively worse prices. RFQ liquidity providers can absorb larger sizes at a single price.
...
Live liquidity provider quotes are typically valid for 2 seconds.
