...
The `AcceptQuote` execute message is the main settlement entrypoint. It's called by the taker when accepting a maker's quote.
...
| `quotes[].maker` | Maker's Injective address |
